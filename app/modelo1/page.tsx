      ...
      <SectionContainer>
        ...
        >
          ...
          <h4 className="max-w-64 text-lg text-white flex-grow">
            ...
            dolorum dolore asperiores pariatur repudiandae accusamus excepturi
            ex sit fugiat tenetur beatae quae assumenda recusandae labore in
            aliquid, ipsam officiis?
          </h4>
        ...
        <Section className="flex relative flex-col gap-12 items-center justify-center md:px-24">
          ...
          <div className="grid grid-cols-5 gap-6">
            <p className="col-span-3 col-start-3 text-lg">
              ...
              esse ipsam, cupiditate voluptate ut consequuntur, accusamus
              eligendi laborum nobis soluta illum sequi necessitatibus debitis?
              Dolorum perferendis cumque eum sequi.
            </p>
